...
export class SidecarManager implements Service {
  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      const sidecarEventTypes = ['screen_capture', 'context_changed', 'idle_detected', 'clipboard_change', 'pebble.summon', 'pebble.palette', 'pebble.blind_toggle', 'panel.bounds_changed', 'audio.session_start', 'audio.session_end', 'audio.wake_segment', 'region.captured', 'region.cancelled', 'sub_pebble.clicked', 'sub_pebble.open_full'];
